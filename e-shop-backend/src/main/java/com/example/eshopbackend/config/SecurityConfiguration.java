...
public class SecurityConfiguration {
    ...
    private final EshopAuthenticationManager eshopAuthenticationManager;

    private final String secret = "longenoughsecrettotestjwtencrypt";

    @Bean
    public AuthenticationManager authenticationManager(){
        return new ProviderManager(eshopAuthenticationManager);
    }
    ...
    public AuthorizationManager<RequestAuthorizationContext> requestMatcherAuthorizationManager
        ...
        managerBuilder.add(new MvcRequestMatcher(introspector, "/items/**"),
