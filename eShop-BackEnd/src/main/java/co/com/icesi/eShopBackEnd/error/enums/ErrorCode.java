package co.com.icesi.eShopBackEnd.error.enums;
...
public enum ErrorCode {
    ...
    ERR_401("ERR_401", "You are not authorized to access this resource"),
    ...
    ERR_NOT_ENOUGH_STOCK("ERR_NOT_ENOUGH_STOCK", "Not enough stock for %s");
