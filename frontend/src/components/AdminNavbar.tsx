        ...
        <nav className="navbar navbar-expand-lg bg-body-tertiary" style={{backgroundColor: "#FAD011"}}>
          <div className="container">
              ...
              <ul className="navbar-nav me-auto mb-2 mb-lg-0" style={{fontSize: "1.25rem"}}>
                  ...
                  <a className="nav-link active" aria-current="page" href="/admin/users">Users</a>
                  </li>
                  <li className="nav-item">
                  <a className="nav-link active" aria-current="page" href="/admin/items">Items</a>
                  </li>
                  <li className="nav-item">
                  <a className="nav-link active" aria-current="page" href="/admin/orders">Orders</a>
                  </li>
              </ul>
              <Logout />
              </div>
