      ...
      <>
        ...
        <nav className="navbar navbar-expand-lg bg-body-tertiary" style={{backgroundColor: "#212529"}}>
          <div className="container">
              <a className="navbar-brand" href="/home-shop">
        ...
        <nav className="navbar navbar-expand-lg bg-body-tertiary" style={{backgroundColor: "#212529"}}>
          <div className="container">
              ...
              <ul className="navbar-nav me-auto mb-2 mb-lg-0" style={{fontSize: "1.25rem"}}>
                  ...
                  <li className="nav-item">
                    <a className="nav-link text-white" aria-current="page" href="/home-shop">Items</a>
                  </li>
                  <li className="nav-item">
                    <a className="nav-link text-white" aria-current="page" href="/orders">Ordenes</a>
                  </li>
